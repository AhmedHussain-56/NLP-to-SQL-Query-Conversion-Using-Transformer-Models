...
def generate_sql(user_query):
    ...
    model_prompt = f"Convert the following natural language query into an SQL statement. Only return the SQL query, nothing else: {user_query}"
    ...
    try:
        ...
        print("Full Response from Groq:", full_response)  # Debugging
        ...
        if sql_block_match:
            ...
            sql_query = sql_match.group(0).strip() if sql_match else full_response.strip()
